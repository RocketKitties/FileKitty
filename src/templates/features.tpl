	...
	<div class="section">
		<div class="row">
			<div class="col-sm-6">
				...
				<p><%= application.name %> allows you to share your files in a variety of ways.  Create hyperlinks to files or folders for easy sharing with anyone or create shared file or folders to share with your <%= application.name %> connections. </p>
			</div>
			<div class="col-sm-6">
				<div class="icon-grid figure">
					<div class="file item">
